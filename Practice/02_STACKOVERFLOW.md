...
```
- 실행 결과
![](../images/Pasted_image_20260118150920.png)
...
- TASK2 코드 수정 2
- 수정 내용: 배열 선언만 했었는데, 실제로 메모리에 값을 쓰도록 수정. 
```c
#if 1
...
//#define configCHECK_FOR_STACK_OVERFLOW           2
```
- 옵션이 1,2번 2개 있는데 1번은 현실성이 별로 없어서 2번을 사용하는 것이 좋지만 2번도 완전히 stack overflow를 발견하지는 못한다
